  ...
  return (
    <div className="group bg-white rounded-md shadow hover:shadow-lg transition-shadow duration-200 p-5 px-6 mr-12 relative min-h-[50px] flex items-center">
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex-shrink-0 flex gap-3 items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button
            onClick={() => onEdit(learning._id)}
            className="text-gray-400 hover:text-purple-400 transition-colors duration-200"
            aria-label="Editar objetivo"
          >
            <PencilIcon className="h-5 w-5" strokeWidth={2} />
          </button>
          <button
